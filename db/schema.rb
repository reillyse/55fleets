...
ActiveRecord::Schema.define(version: 2022_02_10_220148) do
  ...
  create_table "certificate_load_balancers", id: :serial, force: :cascade do |t|
  ...
  create_table "fleets", id: :serial, force: :cascade do |t|
    ...
    t.index ["app_id"], name: "index_fleets_on_app_id"
  end
  ...
  create_table "machines", id: :serial, force: :cascade do |t|
    ...
    t.datetime "busy"
    t.text "build_notes"
    t.index ["busy"], name: "index_machines_on_busy"
    t.index ["instance_id"], name: "index_machines_on_instance_id"
    t.index ["ip_address"], name: "index_machines_on_ip_address"
    t.index ["pod_id"], name: "index_machines_on_pod_id"
    t.index ["spot_fleet_request_id", "state"], name: "index_machines_on_spot_fleet_request_id_and_state"
    t.index ["spot_fleet_request_id"], name: "index_machines_on_spot_fleet_request_id"
    t.index ["state"], name: "index_machines_on_state"
    t.index ["subnet_id"], name: "index_machines_on_subnet_id"
  end
  ...
  create_table "pods", id: :serial, force: :cascade do |t|
    ...
    t.text "spot_type"
    t.string "spot_bid"
    t.index ["builder_id"], name: "index_pods_on_builder_id"
    t.index ["fleet_id"], name: "index_pods_on_fleet_id"
  end
  ...
  create_table "spot_fleet_requests", id: :serial, force: :cascade do |t|
    ...
    t.index ["pod_id"], name: "index_spot_fleet_requests_on_pod_id"
    t.index ["state"], name: "index_spot_fleet_requests_on_state"
  end
