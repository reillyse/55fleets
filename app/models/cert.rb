class Cert < ActiveRecord::Base
  ...
  attr_encrypted :certificate, :key => ENV["CERT_KEY_SECRET"], :mode => :per_attribute_iv_and_salt
  attr_encrypted :private_key, :key => ENV["CERT_KEY_SECRET"], :mode => :per_attribute_iv_and_salt
