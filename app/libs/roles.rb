class Roles
  ...
  def create_spot_fleet_role
    ...
    client.attach_role_policy role_name: spot_fleet_role_name,
                              policy_arn: policy.arn
    client.attach_role_policy policy_arn:
  ...
  def create_policy
    ...
    return(
      client.create_policy(
        { policy_document: admin_policy.to_json, policy_name: policy_name }
      ).policy
    )
  end
  ...
  def admin_policy
    {
      "Version": '2012-10-17',
      "Statement": [
        { "Effect": 'Allow', "Action": %w[ec2:*], "Resource": '*' },
        {
          "Effect": 'Allow',
          "Action": %w[iam:ListRoles iam:PassRole iam:ListInstanceProfiles],
          "Resource": '*'
        }
      ]
    }
  ...
  def trust_policy_doc
    {
      ...
      "Statement": [
        ...
        {
          "Effect": 'Allow',
          "Principal": { "Service": 'spot.amazonaws.com' },
          "Action": 'sts:AssumeRole'
        }
      ]
    }
